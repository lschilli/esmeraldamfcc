 ...
 *	dupliziert den �bergebenen 'dim'-dimensionalen
 *	Vektor 'vec' und gibt ihn zur�ck
 **/
 ...
 *	kopiert die den �bergebenen 'dim'-dimensionalen Vektor 'src'
 *	nach 'dest' (der ggf. angelegt wird)und gibt diesen zur�ck
 **/
